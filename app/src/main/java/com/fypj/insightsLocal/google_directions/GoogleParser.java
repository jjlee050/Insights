package com.fypj.insightsLocal.google_directions;
    ...
    public Route parse() {
        ...
        try {
            ...
            for (int i = 0; i < numSteps; i++) {
                ...
                segment.setMode(step.getString("travel_mode"));
                segment.setDuration(step.getJSONObject("duration").getInt("value"));
